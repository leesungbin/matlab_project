...
%             subplot(4,1,2)
%             plot(range,drop(1:length(range./dt+1),1,1))
%             subplot(4,1,3)
%             plot(range,drop(1:length(range./dt+1),2,1))
%             subplot(4,1,4)
%             plot(range,drop(1:length(range./dt+1),5,1))
            hold on
            ...
            for k = life(i)+1:length(drop(:,1,1))
                drop(k,:,1)=[0 0 0 0 0 0];
            end
        end
    end
